 ...
 * @e_ident: this pointer points to an array containing the ELF magic numbers.
 *
 ...
 * @e_ident: this pointer points to an array containing the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
 ...
 * @argc: this is the number of arguments to be supplied to the program.
 * @argv: this is sn array of pointers to the arguments.
 *
